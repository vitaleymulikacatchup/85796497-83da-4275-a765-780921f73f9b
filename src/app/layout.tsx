...
export const metadata: Metadata = {
  title: "SkyDriver - Tandem Skydiving & Training",
  description: "Experience thrilling tandem skydiving and professional AFF training with certified instructors. Safe, unforgettable adventures await.",
  keywords: "skydiving, tandem jump, AFF training, freefall, adventure sports",
  metadataBase: new URL("https://skydriver.com"),
  alternates: {
    canonical: "https://skydriver.com",
  },
  openGraph: {
    title: "SkyDriver - Feel the Rush of Freefall",
    description: "Book your skydiving adventure with certified instructors and experience the ultimate thrill.",
    url: "https://skydriver.com",
    siteName: "SkyDriver",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763567119105-mpo7z48v.jpg",
        alt: "Skydiver in freefall above clouds",
      },
    ],
    type: "website",
  },
  twitter: {
    ...
    title: "SkyDriver - Tandem Skydiving",
    description: "Experience the ultimate adventure with certified skydiving instructors.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763567119105-mpo7z48v.jpg"],
  },
};
